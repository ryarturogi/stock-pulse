...
describe('/api/quote', () => {
  ...
  describe('Successful Requests', () => {
    it('should return stock quote for valid symbol', async () => {
      const request = new NextRequest('http://localhost:3000/api/quote?symbol=AAPL');
    ...
    it('should handle symbols with special characters', async () => {
      const request = new NextRequest('http://localhost:3000/api/quote?symbol=BRK.A');
    ...
    it('should handle URL encoded symbols', async () => {
      const request = new NextRequest('http://localhost:3000/api/quote?symbol=BRK%2EA');
  ...
  describe('Request Validation', () => {
    ...
    it('should return 400 when symbol parameter is empty', async () => {
      const request = new NextRequest('http://localhost:3000/api/quote?symbol=');
    ...
    it('should handle whitespace-only symbol', async () => {
      const request = new NextRequest('http://localhost:3000/api/quote?symbol=%20%20%20');
    ...
    it('should handle multiple symbol parameters', async () => {
      const request = new NextRequest('http://localhost:3000/api/quote?symbol=AAPL&symbol=GOOGL');
  ...
  describe('Finnhub API Errors', () => {
    it('should handle Finnhub API 404 error', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/quote?symbol=INVALID');
      ...
      expect(console.error).toHaveBeenCalledWith('Stock quote API error:', expect.any(Error));
    });
  ...
  describe('Network Errors', () => {
    ...
    it('should handle DNS resolution failure', async () => {
      (fetch as jest.Mock).mockRejectedValue(new Error('getaddrinfo ENOTFOUND finnhub.io'));
  ...
  describe('Edge Cases', () => {
    it('should handle very long symbol names', async () => {
      ...
      const request = new NextRequest(`http://localhost:3000/api/quote?symbol=${longSymbol}`);
    ...
    it('should handle symbols with unicode characters', async () => {
      ...
      const request = new NextRequest(`http://localhost:3000/api/quote?symbol=${encodedSymbol}`);
    ...
    it('should handle malformed URLs gracefully', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/quote?symbol=AAPL&invalid=param&');
  ...
  describe('Performance and Reliability', () => {
    it('should handle concurrent requests', async () => {
      const request1 = new NextRequest('http://localhost:3000/api/quote?symbol=AAPL');
      const request2 = new NextRequest('http://localhost:3000/api/quote?symbol=GOOGL');
      const request3 = new NextRequest('http://localhost:3000/api/quote?symbol=MSFT');
  ...
  describe('Response Format Consistency', () => {
    it('should always return consistent JSON structure', async () => {
      ...
      const expectedKeys = [
        'symbol', 'current', 'change', 'percentChange',
        'high', 'low', 'open', 'previousClose', 'timestamp'
      ];
